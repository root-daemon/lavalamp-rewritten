...
export class PermissionBoxManager extends BaseBoxManager<"allow" | "deny" | "always"> {
  ...
  protected getDefaultValue(): "allow" | "deny" | "always" {
   ...
   async show(request: PermissionRequestMsg): Promise<"allow" | "deny" | "always"> {
    ...
    this.timer = setTimeout(() => {
      if (this.isVisible()) {this.hide("deny");}
    }, 30_000);
